...
#define MUX_DEFAULT()\
	...
	MUX_VAL(CP(GPMC_A1),        (IEN  | PTD | DIS | M4)) /*GPMC_A1*/\
	MUX_VAL(CP(GPMC_A2),        (IEN  | PTD | DIS | M4)) /*GPMC_A2*/\
	MUX_VAL(CP(GPMC_A3),        (IEN  | PTD | DIS | M4)) /*GPMC_A3*/\
	MUX_VAL(CP(GPMC_A4),        (IEN  | PTD | DIS | M4)) /*GPMC_A4*/\
	MUX_VAL(CP(GPMC_A5),        (IEN  | PTD | DIS | M4)) /*GPMC_A5*/\
	...
	MUX_VAL(CP(GPMC_A10),       (IEN  | PTD | DIS | M4)) /*GPMC_A10*/\
