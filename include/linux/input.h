...
#if !defined(CONFIG_MACH_VAR_SOM_AM35) && !defined(CONFIG_MACH_VAR_SOM_OM3X)
#define EV_VERSION		0x010001
#else
/* Hack to make libts from 2.6.32 FS to recognize touchscreen.
 * Probably the correct solution is to upgrade libts.
 * Vladik, 13.06.2011
 */
