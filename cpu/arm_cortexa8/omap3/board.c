...
static int do_switch_ecc(cmd_tbl_t * cmdtp, int flag, int argc, char *argv[])
{
	...
	else if (strncmp(argv[1], "bch4_ce", 7) == 0)
		omap_nand_switch_ecc(NAND_ECC_4BIT_SOFT_CE);
	else if (strncmp(argv[1], "bch8_ce", 7) == 0)
		omap_nand_switch_ecc(NAND_ECC_8BIT_SOFT_CE);
	else
		goto usage;
